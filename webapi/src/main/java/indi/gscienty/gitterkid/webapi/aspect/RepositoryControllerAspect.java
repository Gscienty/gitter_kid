...
public class RepositoryControllerAspect {
	...
	public Object aroundGetTree(ProceedingJoinPoint point) throws Throwable {
		...
		String path = (String) ((HttpServletRequest) args[0])
				.getAttribute(HandlerMapping.PATH_WITHIN_HANDLER_MAPPING_ATTRIBUTE);
		String bestMatchPattern = (String) ((HttpServletRequest) args[0])
				.getAttribute(HandlerMapping.BEST_MATCHING_PATTERN_ATTRIBUTE);
		
		args[4] = "/" + (new AntPathMatcher().extractPathWithinPattern(bestMatchPattern, path));
